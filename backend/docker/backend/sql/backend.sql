GRANT ALL PRIVILEGES ON DATABASE snapr TO snapr;
...
GRANT ALL PRIVILEGES ON TABLE block TO snapr;
GRANT ALL PRIVILEGES ON TABLE harvester_error TO snapr;
GRANT ALL PRIVILEGES ON TABLE event TO snapr;
GRANT ALL PRIVILEGES ON TABLE extrinsic TO snapr;
GRANT ALL PRIVILEGES ON TABLE account TO snapr;
GRANT ALL PRIVILEGES ON TABLE contract TO snapr;
GRANT ALL PRIVILEGES ON TABLE total TO snapr;
